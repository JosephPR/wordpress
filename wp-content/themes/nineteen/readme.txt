...
* Animations jQuery library @ 2014, Joe Mottershaw, https://github.com/joemottershaw/, MIT License
* Popper @ 2014, Federico Zivolo, http://opensource.org/licenses/MIT). MIT License
* Custom script @ 2019, Weblizar, GPL

= BUNDELED CSS =

* Font Awesome Free 5.3.1 by @fontawesome - https://fontawesome.com , MIT License
* Bootstrap CSS, @ 2018 Twitter, MIT License
* Swiper CSS, @ 2018, Vladimir Kharlampidi,  http://www.idangero.us/swiper/, MIT License
* Animate CSS, @ 2014, Joe Mottershaw, https://github.com/joemottershaw/ 
* Responsive CSS, @ 2019, weblizar, GPL
* main_style CSS, @ 2019, weblizar, GPL 
* Document_style CSS, @ 2019, weblizar, GPL 

= Photo Credit =
 * https://stocksnap.io/photo/FIJPLQAAF4
 * https://stocksnap.io/photo/CKCUPJTGTL
