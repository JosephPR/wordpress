...
<body <?php body_class(); ?>>
    ...
    <!--header-part-->
    <div class="header_banner clearfix" style="background-image: url(<?php header_image(); ?>)">
        <header>
            <!--navbar-->
            <nav class="navbar navbar-expand-sm animate " data-anim-type="fadeInLeft" data-anim-delay="400">
                <div class="container navbar-containernt animate " data-anim-type="fadeInRight" data-anim-delay="400">
	                ...
	                <?php }
	                     	...
	                     	echo get_theme_mod('display_header_text');
	                ?>
                    <?php if (display_header_text()==true){ ?>
	                <a class="navbar-brand" href="<?php echo esc_url( home_url() ); ?>">
	                    <span class="site-title"><?php esc_html( bloginfo('name') ); ?></span>
	                </a>
	                <p><span class="site-description"><?php echo get_theme_mod('display_header_text'); esc_html( bloginfo('description') ); ?></span></p>
	                <?php } } ?>
					</div>
        ...
        <?php get_template_part( 'home-sections/home', 'slider' ); ?>
    </div>