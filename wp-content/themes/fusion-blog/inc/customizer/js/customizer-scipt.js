...
*/
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #fusion-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_blog #fusion-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('fusion-blog-radio-img-selected') ;
        });
        $(this).addClass ('fusion-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #fusion-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_archive #fusion-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('fusion-blog-radio-img-selected') ;
        });
        $(this).addClass ('fusion-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #fusion-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_page #fusion-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('fusion-blog-radio-img-selected') ;
        });
        $(this).addClass ('fusion-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #fusion-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_single #fusion-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('fusion-blog-radio-img-selected') ;
        });
        $(this).addClass ('fusion-blog-radio-img-selected') ;
    });   

    $('#customize-control-theme_options-layout_options_boxed #fusion-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_boxed #fusion-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('fusion-blog-radio-img-selected') ;
        });
        $(this).addClass ('fusion-blog-radio-img-selected') ;
    });                    
